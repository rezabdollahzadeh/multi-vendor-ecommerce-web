                                ...
                                <div class="form-group">
                                    ...
                                    <select id="inputState" class="form-control main-category" name="category">
                                        ...
                                        @foreach ($categories as $category)
                                            <option
                                                {{$category->id == $childCategory->category_id ? 'selected' : ''}} value="{{$category->id}}">{{$category->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group">
                                    ...
                                    <select id="inputState" class="form-control sub-category" name="sub_category">
                                        ...
                                        @foreach ($subCategories as $subCategory)
                                            <option
                                                {{$subCategory->id == $childCategory->sub_category_id ? 'selected' : ''}} value="{{$subCategory->id}}">{{$subCategory->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group">
